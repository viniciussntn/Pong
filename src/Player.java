...
/**
	Esta classe representa os jogadores (players) do jogo. A classe principal do jogo (Pong)
...
public class Player {
	...
	*/
	...
	/**
		Método que devolve a cor do retângulo que representa o player.
		@return um objeto do tipo Color.
	*/
